...
$(function() {
	...
	$('#whatisircube h1, #chatform h1').corners("10px top");
});
</script>
<div class="clear"></div>
<div id="whatisircube" class="span-10 push-1">
				<h1>C'est quoi IRCube ?</h1>
				<div class="box">
					<p class="largest">IRCube est un réseau de discussion francophone agréable et sans prise de tête.</p>
				</div>
</div>
<div id="chatform" class="span-10 push-1 last">
	<h1>Tchattez sur IRCube !</h1>
	<div class="box">
		<?php 
...
<div class="clear"></div>
<?php
echo $this->element('news/latest', array('class' => 'span-10 push-1', 'latestNews' => $latestNews));
?>
