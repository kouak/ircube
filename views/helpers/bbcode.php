...
class BbcodeHelper extends AppHelper {
	...
	/*
	string text – text for parsing
	int valid – 0 for invalid html, 1 for xhtml 1.0 strict valid output
	array parse – items in this array will be parsed. Without parameters all items will be parsed.
	*/
	function parse($text, $valid = 1, $parse=null) {
