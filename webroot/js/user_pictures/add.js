function fileQueueError(file, errorCode, message) {
	try {
		...
		case SWFUpload.QUEUE_ERROR.ZERO_BYTE_FILE:
			...
			progress.setStatus("Erreur : ce fichier est invalide.");
			break;
		case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
			imageName = "toobig.gif";
			progress.setStatus("Erreur : ce fichier est trop gros.");
			break;
		case SWFUpload.QUEUE_ERROR.ZERO_BYTE_FILE:
		...
		addImage("/img/swfupload/" + imageName);
...
function uploadSuccess(file, serverData) {
	try {
		...
		if (serverData.substring(0, 9) === "FILENAME:") {
			...
			addImage("/img/swfupload/error.gif");
			progress.setStatus("Erreur : " + serverData.substring(6));
			progress.toggleCancel(false);
			//alert(serverData);
		}
